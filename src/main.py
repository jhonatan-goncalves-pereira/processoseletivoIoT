...
detalhes
---------
implementa um semaforo de trânsito simulado usando o padrão FSM
...
# tempo de cada estado em milissegundos
DURACAO_MS: dict = {
    VERDE:    3000,   # 3s – tempo mínimo para pedestres cruzarem via simples
    AMARELO:  1000,   # 1ss – transitório rápido (padrão DENATRAN)
    VERMELHO: 3000,   # 3  – espera mínima segura antes de liberar novamente
}

# categoriza para saída serial (debug local e evidência de testes no CI)
LABELS: dict = {
...
# inicia hardware
# reqiosotps de seleção dos pinos
...
#  mapeia estado ->  pino GPIO diretamente
